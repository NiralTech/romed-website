        ...
        <div className="h-full">
          <div className="z-30 flex h-screen mt-12 lg:h-auto lg:ml-32">
            <h2 className="flex flex-col justify-center ml-10 lg:mt-40 lg:ml-40">
              <span className="font-semibold text-white"> Revolutionize </span>
              <span className="font-semibold text-white"> Enchant </span>
              <span className="font-semibold text-white"> Gratification </span>
            </h2>
          </div>
          <img
