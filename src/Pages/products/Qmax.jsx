  ...
  <Layout>
    <GradientLayout>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 my-20 md:mx-64 px-4 gap-2">
        ...
        <div>
          <p>
            Both Q10 and Q10 PREMIUM exhibit a flat top-hat beam profile,
            ensuring uniform and consistent energy delivery to the target area.
          </p>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 my-20 md:mx-64 px-4 gap-x-10 gap-y-4">
        ...
        <p>
          By employing the PTP mode, both Q10 and Q10 PREMIUM have the
          capability to emit consecutive dual pulses at a maximum energy of 1.8
          J. In contrast to the single-pulse mode, this configuration allows for
          the delivery of twice the number of pulses, each with nearly half the
          energy per pulse. The advantage lies in its ability to minimize
          treatment discomfort, as it avoids damaging normal surrounding skin
          tissues, a drawback associated with the single-pulse mode.
          Consequently, the reduced likelihood of side effects is achieved
          without compromising clinical results, and in most of cases, may even
        ...
        <div className="flex flex-col ">
          <p>
            ...
            physicians tend to administer less energy to the skin compared to
            PTP, therefore the photothermal effect necessary for collagen
            regeneration may not reach a sufficient level.
          </p>
          <p className="mt-10">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 my-20 md:mx-64 px-4 gap-x-10 gap-y-4">
        ...
        <p>
          ...
          PREMIUM, physicians can administer treatments to patients at the
          optimal settings.
        </p>
      </div>
