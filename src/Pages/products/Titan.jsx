  ...
  <GradientLayout>
    ...
    <div className="grid grid-cols-1 md:grid-cols-2 my-20 md:mx-64 px-4 gap-2">
      ...
      <p>
        ...
        replaced by new, healthier tissue, and eventually appearance of scars is
        improved over time.
      </p>
    </div>
    ...
    <div className="grid grid-cols-1 md:grid-cols-2 my-20 md:mx-64 px-4 gap-2">
      ...
      <p>
        ...
        creating controlled columns of both vaporized and coagulated zones that
        trigger a healing process in the tissue, stimulating the production of
        new collagen, elastin fibres, and vascularization in the vaginal wall.
        This results in enhancing the strength and elasticity of the vaginal
        tissue, eventually leading to improvements in vaginal laxity,
        elasticity, and moisture levels. Over the weeks following the treatment,
        patients may notice improvements in vaginal tightness, lubrication, and
        overall tissue health.
      </p>
      <div className="md:row-span-2 w-96 h-96">
        <img className="content-center h-full w-full" src={gynecology} alt="" />
      </div>
    </div>
