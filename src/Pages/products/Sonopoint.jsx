  ...
  <GradientLayout>
    ...
    <div className="grid grid-cols-1 my-20 md:mx-64 px-4 gap-2">
      ...
      <ul className=" pl-10">
        ...
        <li className="py-2 list-disc">
          Instant results with tightened and lifted skin following the treatment
        </li>
        <li className="py-2 list-disc">
    ...
    <div className="grid grid-cols-1 md:grid-cols-2 my-20 md:mx-64 px-4 gap-2">
      ...
      <div>
        <img className="content-center h-full w-full" src={tips1} alt="" />
      </div>
      <div>
        <img className="content-center h-full w-full" src={tips2} alt="" />
      </div>
      <div>
        <img className="content-center h-full w-full" src={handpiece} alt="" />
      </div>
      <div>
        <img
